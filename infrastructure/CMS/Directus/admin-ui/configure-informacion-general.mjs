...
const CAMPOS = {
  ...
  location: {
    ...
    address: { interface: 'input-multiline', translations: label('Dirección'), note: 'Escriba una dirección pública completa (mínimo 10 caracteres). No la completa el mapa. Ejemplo: Av. Principal, Edificio X, Piso 2, Caracas, Venezuela.', options: { placeholder: 'Av. Principal, Edificio X, Piso 2, Caracas, Venezuela' }, required: true, width: 'full', sort: 4 },
  },
};
