 ...
 * de negocio que el CMS persistirá (`company_profile_id`, `address`, `latitude`,
 * `longitude`). El CMS los fusiona en el registro que finalmente inserta,
 * garantizando que guarde exactamente lo que NestJS validó. El
